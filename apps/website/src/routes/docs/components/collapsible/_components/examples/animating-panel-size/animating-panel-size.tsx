...
export const AnimatingPanelSize = component$(() => {
  return (
    <>
      <HeadingLink.Root id="animating-panel-size" level="3" size="4" class="mt-10 scroll-m-16">
        <HeadingLink.Content>
      ...
      <Text.Root class="mt-3">
        ...
        or <Code.Root size="3">1fr</Code.Root> value to animate the size of the panel when it opens/closes.
      </Text.Root>
