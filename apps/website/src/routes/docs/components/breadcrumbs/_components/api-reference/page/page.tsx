...
export const Page = component$(() => {
  return (
    <>
      <HeadingLink.Root id="page" level="3" size="4" class="mt-10 scroll-m-16">
        <HeadingLink.Content>
          Page
          <HeadingLink.Icon />
        </HeadingLink.Content>
      ...
      <Text.Root class="mt-3">
        A component that represents the current page. Should be nested inside{' '}
        <Code.Root size="3">Breadcrumbs.Item</Code.Root>. This component is based on the{' '}
        <Code.Root size="3">span</Code.Root> element.
      </Text.Root>

      <HeadingLink.Root id="page-props" level="4" size="3" class="mt-8 scroll-m-16">
        <HeadingLink.Content>
          Props
          <HeadingLink.Icon />
        </HeadingLink.Content>
      ...
      <HeadingLink.Root id="page-data-attributes" level="4" size="3" class="mt-8 scroll-m-16">
        <HeadingLink.Content>
          Data attributes
          <HeadingLink.Icon />
        </HeadingLink.Content>
