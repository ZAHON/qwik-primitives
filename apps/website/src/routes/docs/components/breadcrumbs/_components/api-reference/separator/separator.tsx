...
export const Separator = component$(() => {
  return (
    <>
      <HeadingLink.Root id="separator" level="3" size="4" class="mt-10 scroll-m-16">
        <HeadingLink.Content>
          Separator
          <HeadingLink.Icon />
        </HeadingLink.Content>
      ...
      <Text.Root class="mt-3">
        Used to visually separate breadcrumbs items. Should be nested inside{' '}
        <Code.Root size="3">Breadcrumbs.Item</Code.Root>. This component is based on the{' '}
        <Code.Root size="3">span</Code.Root> element.
      </Text.Root>

      <HeadingLink.Root id="separator-props" level="4" size="3" class="mt-8 scroll-m-16">
        <HeadingLink.Content>
          Props
          <HeadingLink.Icon />
        </HeadingLink.Content>
      ...
      <HeadingLink.Root id="separator-data-attributes" level="4" size="3" class="mt-8 scroll-m-16">
        <HeadingLink.Content>
          Data attributes
          <HeadingLink.Icon />
        </HeadingLink.Content>
