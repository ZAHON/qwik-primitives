  ...
  return (
    <>
      ...
      <Text.Root class="mt-3">
        Contains all the parts of a collapsible section. This component is based on the{' '}
      ...
      <ComponentProps
        data={[
          ...
          {
            propName: 'value',
            propDescription: <Text.Root size="2">A unique value for the item.</Text.Root>,
            propRequired: true,
            typeValue: 'string',
            defaultValue: '',
          },
          {
            ...
            propDescription: (
              <Text.Root size="2">
                When <Code.Root size="2">true</Code.Root>, prevents the user from interacting with the item.
              </Text.Root>
            ),
            typeValue: 'boolean',
            defaultValue: '',
