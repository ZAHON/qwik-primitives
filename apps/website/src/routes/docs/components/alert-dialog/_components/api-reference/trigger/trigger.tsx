...
export const Trigger = component$(() => {
  return (
    <>
      <HeadingLink.Root id="trigger" level="3" size="4" class="mt-10 scroll-m-16">
        <HeadingLink.Content>
          Trigger
          <HeadingLink.Icon />
        </HeadingLink.Content>
      ...
      <Text.Root class="mt-3">
        The button that opens the alert dialog. This component is based on the <Code.Root size="3">button</Code.Root>{' '}
        element.
      </Text.Root>

      <HeadingLink.Root id="trigger-props" level="4" size="3" class="mt-8 scroll-m-16">
        <HeadingLink.Content>
          Props
          <HeadingLink.Icon />
        </HeadingLink.Content>
      ...
      <ComponentProps
        data={[
          ...
          },
          {
            ...
            propDescription: (
              <Text.Root size="2">
                When <Code.Root size="2">true</Code.Root>, prevents the user from interacting with the trigger.
              </Text.Root>
            ),
            typeValue: 'boolean',
            defaultValue: '',
      ...
      <HeadingLink.Root id="trigger-data-attributes" level="4" size="3" class="mt-8 scroll-m-16">
        <HeadingLink.Content>
          Data attributes
          <HeadingLink.Icon />
        </HeadingLink.Content>
