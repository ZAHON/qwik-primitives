...
export const Action = component$(() => {
  return (
    <>
      <HeadingLink.Root id="action" level="3" size="4" class="mt-10 scroll-m-16">
        <HeadingLink.Content>
          Action
          <HeadingLink.Icon />
        </HeadingLink.Content>
      ...
      <Text.Root class="mt-3">
        A button that closes the alert dialog. These buttons should be distinguished visually from the{' '}
        <Code.Root size="3">AlertDialog.Cancel</Code.Root> button. This component is based on the{' '}
        <Code.Root size="3">button</Code.Root> element.
      </Text.Root>

      <HeadingLink.Root id="action-props" level="4" size="3" class="mt-8 scroll-m-16">
        <HeadingLink.Content>
          Props
          <HeadingLink.Icon />
        </HeadingLink.Content>
      ...
      <HeadingLink.Root id="action-data-attributes" level="4" size="3" class="mt-8 scroll-m-16">
        <HeadingLink.Content>
          Data attributes
          <HeadingLink.Icon />
        </HeadingLink.Content>
