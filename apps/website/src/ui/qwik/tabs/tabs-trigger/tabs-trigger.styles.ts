  ...
  ],
  {
    ...
    compoundVariants: [
      ...
      // color success
      {
        color: 'success',
        highContrast: false,
        class: ['data-[state=active]:before:bg-success-solid-9'],
      },
      {
        color: 'success',
        highContrast: true,
        class: ['data-[state=active]:before:bg-success-solid-12'],
      },
      ...
      // color warning
      {
        color: 'warning',
        highContrast: false,
        class: ['data-[state=active]:before:bg-warning-solid-9'],
      },
      {
        color: 'warning',
        highContrast: true,
        class: ['data-[state=active]:before:bg-warning-solid-12'],
      },
      ...
      // color danger
      {
        color: 'danger',
        highContrast: false,
        class: ['data-[state=active]:before:bg-danger-solid-9'],
      },
      {
        color: 'danger',
        highContrast: true,
        class: ['data-[state=active]:before:bg-danger-solid-12'],
      },
    ],
  }
);
