...
export type { TabsTriggerContentProps as TriggerContentProps } from './tabs-trigger-content';
...
export { TabsTriggerContent as TriggerContent } from './tabs-trigger-content';
