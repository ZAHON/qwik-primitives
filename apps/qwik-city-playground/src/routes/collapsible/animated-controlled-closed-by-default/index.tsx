...
import { AnimatedControlledClosedByDefault } from '@/demos/collapsible/animated-controlled-closed-by-default';
...
export const head: DocumentHead = {
  title: 'Collapsible animated controlled closed by default | Qwik Primitives Qwik City Playground',
  meta: [
    {
      name: 'description',
