...
/**
 * The `b` element is used to draw the reader's attention to the element's contents,
 ...
 * If you wish to create boldface text, you should use the CSS `font-weight` property.
