...
export const AlertDialogContent = component$<AlertDialogContentProps>((props) => {
  ...
  const { isOpen, setIsOpen$, triggerRef, contentId, titleId, descriptionId } = useContext(AlertDialogContext);
  ...
  useTask$(() => {
    ...
    contentId.value = id || `qwik-primitives-alert-dialog-content-${autoId}`;
  });
